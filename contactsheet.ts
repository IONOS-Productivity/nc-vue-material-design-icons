...
import { MappingStatus } from './iconsMapper';
...
async function build() {
  ...
  for (const mdiIconId in mapping.icons) {
    ...
    const viewBox = viewBoxes[mdiIconId] || viewBoxDefault;
    ...
    const mappingResultHtml = stats[mdiIconId] === MappingStatus.REMAPPED ? mappingHtmlSuccess : mappingHtmlNotMapped
